...
void print_oafile(unsigned char *e_ident);
...
/**
 * print_c - function prints the class of an ELF header.
...
/**
 * print_d -  function  prints the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_d(unsigned char *e_ident)
{
...
/**
 * print_oafile - Prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void print_oafile(unsigned char *e_ident)
{
...
/**
 * print_ent - function prints the entry point of an ELF header.
...
/**
 * main - contains the ELF header at the start of an ELF file.
